...
public class City extends Point2D.Float{
	...
	public City(String n, String xC, String yC, String r, String c, String x, String y) {
		name = n;
		try {
			super.x = Integer.parseInt(xC);
			super.y = Integer.parseInt(yC);
			radius = Integer.parseInt(r);
			remoteX = Integer.parseInt(x);
			remoteY = Integer.parseInt(y);
	...
	public String getremoteX(){
		return Integer.toString(remoteX);
	}
	public String getremoteY(){
		return Integer.toString(remoteY);
	}
